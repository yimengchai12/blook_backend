...
insert into coupon (coupon_id, coupon_point, coupon_code) values (1, 100, 'ONEDOLLAR');
insert into coupon (coupon_id, coupon_point, coupon_code) values (2, 200, 'TWODOLLAR');
insert into coupon (coupon_id, coupon_point, coupon_code) values (3, 300, 'THREEDOLLAR');
insert into coupon (coupon_id, coupon_point, coupon_code) values (4, 400, 'FOURDOLLAR');
