...
insert into customer (first_name, last_name, email, gender, address, billing_address, phone) values ('Mitch', 'Redhead', 'mredhead2@github.com', 'Male', '690 Linden Avenue', null, '+351 (847) 794-9904', 0);
insert into customer (first_name, last_name, email, gender, address, billing_address, phone) values ('Shani', 'Hurdedge', 'shurdedge3@github.com', 'Female', '212 6th Circle', '351 Mcbride Street', '+1 (318) 919-8632', 40);
insert into customer (first_name, last_name, email, gender, address, billing_address, phone) values ('Maggee', 'Lamberto', 'mlamberto4@ted.com', 'Female', '93620 Rockefeller Place', null, '+55 (261) 375-3977', 20);
insert into customer (first_name, last_name, email, gender, address, billing_address, phone) values ('Alfie', 'Jaume', 'ajaume5@blogs.com', 'Female', '33010 Spenser Hill', '4 Esch Court', '+63 (464) 166-9286',70);
insert into customer (first_name, last_name, email, gender, address, billing_address, phone) values ('Matty', 'Bulger', 'mbulger6@last.fm', 'Male', '9617 Marcy Point', '334 Wayridge Circle', '+81 (493) 771-6802', 90);
insert into customer (first_name, last_name, email, gender, address, billing_address, phone) values ('Addie', 'Radleigh', 'aradleigh7@huffingtonpost.com', 'Male', '8 Maple Wood Point', '47 Atwood Plaza', '+86 (647) 295-2989', 120);
insert into customer (first_name, last_name, email, gender, address, billing_address, phone) values ('Celesta', 'Maevela', 'cmaevela8@cornell.edu', 'Female', '65 Knutson Center', '937 Declaration Pass', '+234 (562) 104-9126',400);
insert into customer (first_name, last_name, email, gender, address, billing_address, phone) values ('Enid', 'MacColl', 'emaccoll9@addthis.com', 'Female', '70 Arrowood Lane', '43 Toban Plaza', '+51 (501) 234-7513',500);
insert into customer (first_name, last_name, email, gender, address, billing_address, phone) values ('Tomasine', 'Hardey', 'thardeya@adobe.com', 'Female', '2 Sachtjen Terrace', null, '+86 (185) 671-6110',2400);
insert into customer (first_name, last_name, email, gender, address, billing_address, phone) values ('Basil', 'Kimmons', 'bkimmonsb@eventbrite.com', 'Male', '81976 Brickson Park Court', '46 Maple Lane', '+62 (925) 588-4272',2500);
insert into customer (first_name, last_name, email, gender, address, billing_address, phone) values ('Clarke', 'Croome', 'ccroomec@slate.com', 'Male', '46432 Weeping Birch Lane', null, '+46 (221) 492-7667',500);
insert into customer (first_name, last_name, email, gender, address, billing_address, phone) values ('Tremaine', 'Tapply', 'ttapplyd@istockphoto.com', 'Male', '79620 Transport Junction', '05 Farmco Lane', '+62 (482) 456-6399',2000);
